...
export async function getStaticProps() {
  try {
    ...
    4) No caso do id, atribuímos a própria chave de cada objeto. Portanto, em vez de ids numéricos, os ids passam a ser na aplicação o próprio hash/código de cada post.  */
